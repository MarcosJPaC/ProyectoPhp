...
$edad=$_POST["Stock"];
$especialidad=$_POST["Area"];
$idn=$_POST['idmod'];
$marcanombre =$_POST['txtMarca'];
$ventanombre =$_POST['txtVenta'];
$categorianombre =$_POST['txtCategoria'];


      if($modificagrega=="agregado"){
        $sql = "INSERT INTO producto (nombre, precio, stock,area,idMarca,idVenta,idCategoria) VALUES ('".$nombre."','".$apellido."','".$edad."','".$especialidad."','".$marcanombre."','".$ventanombre."','".$categorianombre."')";
        $resultado = mysqli_query($conn,$sql);

      }
      if($modificagrega=="modificado"){
        $sql= "UPDATE producto SET nombre = '".$nombre."', precio = '".$apellido."', stock='".$edad."', area='".$especialidad."', idMarca ='".$marcanombre."', idVenta ='".$ventanombre."', idCategoria ='".$categorianombre."' WHERE idProducto = '".$idn."'";
        $resultado = mysqli_query($conn,$sql);
...
header("Refresh: 2; url=productos.php");
  ...
  ::-webkit-scrollbar-thumb:hover {
    ...
    <div class="height-90 bg-light align-items-center">
        ...
        <?php
echo '
        <h4>Producto '.$modificagrega.' con exito! </h4>
    ';
    //Termina echo1
