...
$marcanombre =$_POST['txtMarca'];
      ...
      if($modificagrega=="agregado"){
        $sql = "INSERT INTO empleado (nombre, edad, fechaIngreso,puesto) VALUES ('".$nombre."','".$apellido."','".$edad."','".$especialidad."')";
        $resultado = mysqli_query($conn,$sql);

      }
      if($modificagrega=="modificado"){
        $sql= "UPDATE empleado SET nombre = '".$nombre."', edad = '".$apellido."', fechaIngreso='".$edad."', puesto='".$especialidad."' WHERE idEmpleado = '".$idn."'";
        $resultado = mysqli_query($conn,$sql);
