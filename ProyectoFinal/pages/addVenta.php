...
$idn=$_POST['idmod'];
$marcanombre =$_POST['txtEmpleado'];


      if($modificagrega=="agregado"){
        $sql = "INSERT INTO venta (fecha, total, unidadesVendidas,vendedor,idEmpleado) VALUES ('".$nombre."','".$apellido."','".$edad."','".$especialidad."','".$marcanombre."')";
        $resultado = mysqli_query($conn,$sql);

      }
      if($modificagrega=="modificado"){
        $sql= "UPDATE venta SET fecha = '".$nombre."', total = '".$apellido."', unidadesVendidas='".$edad."', vendedor='".$especialidad."', idEmpleado='".$marcanombre."' WHERE idVenta = '".$idn."'";
        $resultado = mysqli_query($conn,$sql);
