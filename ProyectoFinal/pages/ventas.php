...
while ($colum = mysqli_fetch_array($result))
{
                   ...
                   echo ' </tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><h3> '.$colum ['fecha'].'</h3></td>
                        <td><h3> '.$colum ['total'].'  </h3></td>
                        <td><h2>'.$colum ['unidadesVendidas'].'</h2></td>
                        <td><h2>'.$colum ['vendedor']. '</td><h2>
                        <td><h2>'.$colum ['nombreEmpleado']. '</td><h2>

                        <td><form action="EliminarconfVenta.php" method="POST"> 
                        <input type="hidden" name="id" value="'.$colum ['idVenta'].'">
                        <input class="btn btn-danger" type="submit" value="Eliminar" >
                        </form></h2></td>
                        <td><h2><form action="modVenta.php" method="post"> 
                        <input type="hidden" id="idid" name="id" value="'.$colum ['idVenta'].'">
                        <input type="hidden" id="idmod" name="modificagrega" value="Modificar">
                        <input type="hidden" id="idname" name="nombre" value="'.$colum['fecha'].'">
                        <input type="hidden" id="idprecio" name="precio" value="'.$colum['total'].'">
                        <input type="hidden" id="idstock" name="stock" value="'.$colum['unidadesVendidas'].'">
                        <input type="hidden" id="idarea" name="area" value="'.$colum['vendedor'].'">
