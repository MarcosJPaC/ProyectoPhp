...
$marcanombre =$_POST['txtMarca'];
      ...
      if($modificagrega=="agregado"){
        $sql = "INSERT INTO categoria (nombre, descripcion, abreviatura) VALUES ('".$nombre."','".$apellido."','".$edad."')";
        $resultado = mysqli_query($conn,$sql);

      }
      if($modificagrega=="modificado"){
        $sql= "UPDATE categoria SET nombre = '".$nombre."', descripcion = '".$apellido."', abreviatura='".$edad."' WHERE idCategoria = '".$idn."'";
        $resultado = mysqli_query($conn,$sql);
