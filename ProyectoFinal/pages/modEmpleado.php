...
echo '
    ...
    <div class="form-group"> <!-- Street 1 -->
        <label for="street1_id" class="control-label">Edad</label>
        <input type="text" class="form-control" id="street1_id" name="Precio" value="'.$precio.'">
    </div>                    
                            
    <div class="form-group"> <!-- Street 2 -->
        <label for="street2_id" class="control-label">Fecha de ingreso</label>
    ...
    <div class="form-group"> <!-- City-->
        <label for="city_id" class="control-label">Puesto</label>
