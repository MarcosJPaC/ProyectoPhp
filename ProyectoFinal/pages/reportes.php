        ...
        <nav class="nav">
            <div> <a href="%" class="nav_logo">  <span class="nav_logo-name">Tienda de abarrotes</span> </a>
              ...
              <div class="nav_list"> <a href="productos.php" class="nav_link "> <i class="bi bi-bag-check"></i> <span class="nav_name">Productos</span> </a> 
                  ...
                  <a href="reportes.php" class="nav_link active"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Reportes</span> </a> 
                </div>
...
<h3>Obtener el dato del empleado con mayor antiguedad</h3>
...
?>
              ...
              <form action="../reportes/pdfventa.php" method="post">
<h3>Obtener la venta mas alta en una fecha especificada</h3>
