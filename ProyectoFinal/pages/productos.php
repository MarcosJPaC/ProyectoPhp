                   ...
                   echo ' </tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><h2>'.$colum ['nombreMarca']. '</td><h2>
                        <td><h2>'.$colum ['nombreVenta']. '</td><h2>
                        <td><h2>'.$colum ['nombreCategoria']. '</td><h2>

                        <td><form action="eliminarconfirm.php" method="POST"> 
                        <input type="hidden" name="id" value="'.$colum ['idProducto'].'">
                        <input class="btn btn-danger" type="submit" value="Eliminar" >
                        </form></h2></td>
                        <td><h2><form action="modProducto.php" method="post"> 
                        <input type="hidden" id="idid" name="id" value="'.$colum ['idProducto'].'">
                        <input type="hidden" id="idmod" name="modificagrega" value="Modificar">
                        <input type="hidden" id="idname" name="nombre" value="'.$colum['nombre'].'">
                        <input type="hidden" id="idprecio" name="precio" value="'.$colum['precio'].'">
                        <input type="hidden" id="idstock" name="stock" value="'.$colum['stock'].'">
                        <input type="hidden" id="idarea" name="area" value="'.$colum['area'].'">
...
?>
                  ...
                  <form action="modProducto.php" method="post"> 
...
<h3>Exportar a ...</h3>
<div class="btn-group">
    <form action="../productos/pdf.php" method="post">
        <input class="btn btn-success" type="submit" value="PDF">
    </form>
    <form action="../productos/excel.php" method="post">
        <input class="btn btn-success" type="submit" value="Excel">
    </form>
    <form action="../productos/csv.php" method="post">
        <input class="btn btn-success" type="submit" value="CSV">
    </form>
    <form action="../productos/xml.php" method="post">
        <input class="btn btn-success" type="submit" value="XML">
    </form>
    <form action="../productos/json.php" method="post">
