        ...
        <nav class="nav">
            <div> <a href="%" class="nav_logo">  <span class="nav_logo-name">Tienda de abarrotes</span> </a>
              ...
              <div class="nav_list"> <a href="productos.php" class="nav_link "> <i class="bi bi-bag-check"></i> <span class="nav_name">Productos</span> </a> 
                ...
                </a> <a href="empleados.php" class="nav_link active"><i class="bi bi-person-fill-lock"></i> <span class="nav_name">Empleados</span> </a> 
                   ...
                   echo ' </tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><h3> '.$colum ['edad'].'  </h3></td>
                        <td><h2>'.$colum ['fechaIngreso'].'</h2></td>
                        <td><h2>'.$colum ['puesto']. '</td><h2>
                        <td><form action="EliminarConfEmpleado.php" method="POST"> 
                        <input type="hidden" name="id" value="'.$colum ['idEmpleado'].'">
                        <input class="btn btn-danger" type="submit" value="Eliminar" >
                        </form></h2></td>
                        <td><h2><form action="modEmpleado.php" method="post"> 
                        <input type="hidden" id="idid" name="id" value="'.$colum ['idEmpleado'].'">
                        <input type="hidden" id="idmod" name="modificagrega" value="Modificar">
                        <input type="hidden" id="idname" name="nombre" value="'.$colum['nombre'].'">
                        <input type="hidden" id="idprecio" name="precio" value="'.$colum['edad'].'">
                        <input type="hidden" id="idstock" name="stock" value="'.$colum['fechaIngreso'].'">
                        <input type="hidden" id="idarea" name="area" value="'.$colum['puesto'].'">
...
?>
                  ...
                  <form action="modEmpleado.php" method="post"> 
...
<h3>Exportar a ...</h3>
<div class="btn-group">
    <form action="../empleado/pdf.php" method="post">
        <input class="btn btn-success" type="submit" value="PDF">
    </form>
    <form action="../empleado/excel.php" method="post">
        <input class="btn btn-success" type="submit" value="Excel">
    </form>
    <form action="../empleado/csv.php" method="post">
        <input class="btn btn-success" type="submit" value="CSV">
    </form>
    <form action="../empleado/xml.php" method="post">
        <input class="btn btn-success" type="submit" value="XML">
    </form>
    <form action="../empleado/json.php" method="post">
