...
echo '
    ...
    <div class="form-group"> <!-- Street 1 -->
        <label for="street1_id" class="control-label">Pais</label>
        <input type="text" class="form-control" id="street1_id" name="Precio" value="'.$precio.'">
    </div>                    
                            
    <div class="form-group"> <!-- Street 2 -->
        <label for="street2_id" class="control-label">Popularidad</label>
    ...
    <div class="form-group"> <!-- City-->
        <label for="city_id" class="control-label">Periodo de entrega</label>
