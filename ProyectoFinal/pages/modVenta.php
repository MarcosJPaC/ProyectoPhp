        ...
        <nav class="nav">
            <div> <a href="%" class="nav_logo">  <span class="nav_logo-name">Tienda de abarrotes</span> </a>
              ...
              <div class="nav_list"> <a href="productos.php" class="nav_link "> <i class="bi bi-bag-check"></i> <span class="nav_name">Productos</span> </a> 
                  ...
                  <a href="ventas.php" class="nav_link active"> <i class="bi bi-tags"></i> <span class="nav_name">Venta</span> 
...
echo '
    ...
    <div class="form-group"> <!-- Full Name -->
        <label for="full_name_id" class="control-label">Fecha</label>
        <input type="text" class="form-control" id="full_name_id" name="Nombre" value="'.$nombre.'">
    </div>    

    <div class="form-group"> <!-- Street 1 -->
        <label for="street1_id" class="control-label">Total</label>
        <input type="text" class="form-control" id="street1_id" name="Precio" value="'.$precio.'">
    </div>                    
                            
    <div class="form-group"> <!-- Street 2 -->
        <label for="street2_id" class="control-label">Unidades Vendidas</label>
    ...
    <div class="form-group"> <!-- City-->
        <label for="city_id" class="control-label">Vendedor</label>
    ...
    echo '<select class = "form-select mb-3" name="txtEmpleado" >
    <option selected disabled>--Selecciona el empleado--</option>
    ...
    $dbname = "abarrote";
        ...
        while ($registro = mysqli_fetch_array($datos)) {
            echo "<option value='".$registro['idEmpleado']."'>".$registro['nombre']."</option>";
        }
        echo '</select>';
