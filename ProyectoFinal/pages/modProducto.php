...
<!doctype html>
  ...
  ::-webkit-scrollbar-thumb:hover {
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="%" class="nav_logo">  <span class="nav_logo-name">Tienda de abarrotes</span> </a>
              ...
              <div class="nav_list"> <a href="productos.php" class="nav_link active"> <i class="bi bi-bag-check"></i> <span class="nav_name">Productos</span> </a> 
    ...
    <div class="height-90 bg-light align-items-center">
        ...
        $id=$_POST['id'];
        $modificagrega= $_POST['modificagrega'];
        $nombre=$_POST["nombre"];
        $precio=$_POST["precio"];
        $stock=$_POST["stock"];
        $area=$_POST["area"];
...
echo '
    ...
    <div class="form-group"> <!-- Full Name -->
        ...
        <input type="text" class="form-control" id="full_name_id" name="Nombre" value="'.$nombre.'">
    </div>    

    <div class="form-group"> <!-- Street 1 -->
        <label for="street1_id" class="control-label">Precio</label>
        <input type="text" class="form-control" id="street1_id" name="Precio" value="'.$precio.'">
    </div>                    
                            
    <div class="form-group"> <!-- Street 2 -->
        <label for="street2_id" class="control-label">Stock</label>
        <input type="text" class="form-control" id="street2_id" name="Stock" value="'.$stock.'">
    </div>    

    <input type="hidden" class="form-control" id="tipossa" name="modificagrega" value="'.$tag.'" >
    <input type="hidden" class="form-control" id="idmod" name="idmod" value="'.$id.'" value="'.$stock.'">


    <div class="form-group"> <!-- City-->
        <label for="city_id" class="control-label">Area</label>
        <input type="text" class="form-control" id="city_id" name="Area" value="'.$area.'">
    </div>                                    
                            
    <select class = "form-select mb-3" name="txtMarca" >
...
$dbname = "abarrote";
    ...
    while ($registro = mysqli_fetch_array($datos)) {
        echo "<option value='".$registro['idMarca']."'>".$registro['nombremarca']."</option>";
    }
    echo '</select>';
    ...
    echo '<select class = "form-select mb-3" name="txtVenta" >
    <option selected disabled>--Selecciona la venta--</option>
    <div class="input-contenedor text-center">';
    $servername = "localhost";
    $username = "root";
    $password = "abc";
    $dbname = "abarrote";
        ...
        while ($registro = mysqli_fetch_array($datos)) {
            echo "<option value='".$registro['idVenta']."'>".$registro['vendedor']."</option>";
        }
        echo'</select>';
        // Cerrar la conexión después de usarla
        $conn->close();
        //Termina echo1
        echo '<select class = "form-select mb-3" name="txtCategoria" >
...
echo ' <!-- Submit Button -->
<input type="submit" class="btn" style="background-color: #7357E4;" value="'.$modificagrega.'">
</div>
';
    ?>
