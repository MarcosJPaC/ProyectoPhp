...
$marcanombre =$_POST['txtMarca'];
      ...
      if($modificagrega=="agregado"){
        $sql = "INSERT INTO marca (nombremarca, pais, popularidad,periodoEntrega) VALUES ('".$nombre."','".$apellido."','".$edad."','".$especialidad."')";
        $resultado = mysqli_query($conn,$sql);

      }
      if($modificagrega=="modificado"){
        $sql= "UPDATE marca SET nombremarca = '".$nombre."', pais = '".$apellido."', popularidad='".$edad."', periodoEntrega='".$especialidad."' WHERE idMarca = '".$idn."'";
        $resultado = mysqli_query($conn,$sql);
...
header("Refresh: 2; url=marcas.php");
