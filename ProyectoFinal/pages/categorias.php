        ...
        <nav class="nav">
            <div> <a href="snippets.html" class="nav_logo">  <span class="nav_logo-name">Tienda de abarrotes</span> </a>
              ...
              <div class="nav_list"> <a href="productos.php" class="nav_link "> <i class="bi bi-bag-check"></i> <span class="nav_name">Productos</span> </a> 
                  ...
                  <a href="categorias.php" class="nav_link active"> <i class="bi bi-collection-fill"></i> <span class="nav_name">Categoria</span> </a> 
                   ...
                   echo ' </tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><h3> '.$colum ['descripcion'].'  </h3></td>
                        <td><h2>'.$colum ['abreviatura'].'</h2></td>
                        <td><form action="EliminarCCategoria.php" method="POST"> 
                        <input type="hidden" name="id" value="'.$colum ['idCategoria'].'">
                        <input class="btn btn-danger" type="submit" value="Eliminar" >
                        </form></h2></td>
                        <td><h2><form action="modCategoria.php" method="post"> 
                        <input type="hidden" id="idid" name="id" value="'.$colum ['idCategoria'].'">
                        <input type="hidden" id="idmod" name="modificagrega" value="Modificar">
                        <input type="hidden" id="idname" name="nombre" value="'.$colum['nombre'].'">
                        <input type="hidden" id="idprecio" name="precio" value="'.$colum['descripcion'].'">
                        <input type="hidden" id="idstock" name="stock" value="'.$colum['abreviatura'].'">
...
?>
                  ...
                  <form action="modCategoria.php" method="post"> 
...
<h3>Exportar a ...</h3>
<div class="btn-group">
    <form action="../categoriass/pdf.php" method="post">
        <input class="btn btn-success" type="submit" value="PDF">
    </form>
    <form action="../categoriass/excel.php" method="post">
        <input class="btn btn-success" type="submit" value="Excel">
    </form>
    <form action="../categoriass/csv.php" method="post">
        <input class="btn btn-success" type="submit" value="CSV">
    </form>
    <form action="../categoriass/xml.php" method="post">
        <input class="btn btn-success" type="submit" value="XML">
    </form>
    <form action="../categoriass/json.php" method="post">
